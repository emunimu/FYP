...
const BudgetSettings = () => {
  ...
  return (
    <div>
      ...
      <div>
        <label className="md:text-sm text-xs font-medium text-[#6B7280]">Monthly Budget (Rs)</label>
        <input
          type="number"
          value={monthlyLimit}
      ...
      <div>
        <label className="md:text-sm text-xs font-medium text-[#6B7280]">Target Savings (Rs)</label>
        <input
          type="number"
          value={targetSavings}
          ...
          <table className="w-full text-[#6B7280] border-collapse">
            <thead className="bg-[#E5E7EB]">
              <tr>
                ...
                <th className="px-4 py-2 text-left text-sm md:text-base uppercase text-[#2563EB]">Limit (Rs)</th>
              </tr>
            </thead>
            <tbody>
