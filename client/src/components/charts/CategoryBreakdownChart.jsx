    ...
    if (active && payload && payload.length) {
      return (
        <div className="bg-white p-3 rounded-lg shadow-md border border-gray-200">
          ...
          <p className="text-blue-600">Rs{payload[0].value.toLocaleString()}</p>
            ...
            {data.map((entry, idx) => (
              ...
              >
                ...
                <div className="text-xs text-gray-500 mt-1">
                  {entry.percent}% • Rs{entry.value.toLocaleString()}
                </div>
              </div>
            ))}
          </div>
          ...
          >
            <div className="flex justify-between items-start">
              ...
              <div className="text-right">
                ...
                <p className="text-lg font-semibold text-blue-600">Rs{selected.amount.toLocaleString()}</p>
              </div>
            </div>
