    ...
    <div className="grid md:grid-cols-3 gap-4">
      <div className="p-4 bg-[#E5E7EB] rounded-2xl shadow flex justify-between items-center">
        <div>
          ...
          <p className="md:text-2xl text-lg font-bold text-red-600">
            {summary.biggestSpendingCategory.category} - Rs{summary.biggestSpendingCategory.amount}
          </p>
          <p></p>
        </div>
      ...
      <div className="p-4 bg-[#E5E7EB] rounded-2xl shadow flex justify-between items-center">
        <div>
          ...
          <p className="md:text-2xl text-lg font-bold text-red-600">
            Rs{summary.totalSavingsVsLastMonth.current}
          </p>
          <p className={`text-xs ${
      ...
      <div className="p-4 bg-[#E5E7EB] rounded-2xl shadow flex justify-between items-center">
        <div>
          ...
          <p className="md:text-2xl text-lg font-bold text-red-600">
            Rs{summary.avgDailySpend.current}/day
          </p>
          <p className={`text-xs ${
